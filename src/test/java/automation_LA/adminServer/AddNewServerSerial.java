...
public class AddNewServerSerial {
    ...
    public void adminServerTitleValidation() throws InterruptedException {
        ...
        //Find out the total Length of Name Field
        ...
        //Find out the total Length of Serial Field
        String lengthSerial = driver.findElement(SerialField).getAttribute("Length");
        System.out.println("Serial field total length is :" +lengthSerial);

        //Enter Serial
        Thread.sleep(2000);
        driver.findElement(SerialField).sendKeys("123456");
    }
