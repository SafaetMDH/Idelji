...
public class Archive_Info {
    ...
    private final By SortType = By.xpath("//*[@id=\"archives\"]/div[2]//thead/tr/th[text()='Type']");
    private final By SortTypeVeri = By.xpath("//*[@id=\"archives\"]/div[2]/table[2]/tbody/tr[2]/td[text()='Kudchadkar, Vishal']");
    private final By Info = By.xpath("//*[@id=\"archives\"]/div[2]/table[2]/tbody/tr[2]/td[8]/i[2]");
    private final By CloseButton = By.xpath("//*[@id=\"calendar-detail\"]/div/button[text()='Close']");
    private final By VerifyByDateNTime= By.xpath("//*[@id='calendar-detail']/div[2]/div/table/thead/tr/th[1][text()='Date / Time']");


    private final By Forward = By.xpath("//*[@id=\"archives\"]/div[2]//ul/li/a[text()='<<']");
    ...
    public void navigatingToArchive() throws InterruptedException {
        ...
        //Verify Info dialogue box
        boolean InfoDialogueBox = driver.findElement(VerifyByDateNTime).isDisplayed();
        System.out.println("Info dialogue box appeared :" +InfoDialogueBox);

        //Close the dialogue box
        Thread.sleep(1000);
        driver.findElement(CloseButton).click();
        System.out.printf("Info dialogue box closed :true");
    }
