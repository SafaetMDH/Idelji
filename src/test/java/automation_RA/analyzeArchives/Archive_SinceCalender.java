...
public class Archive_SinceCalender {
    ...
    private final By SinceCalender = By.xpath("//*[@id=\"archives\"]//div//span/button[@class='btn btn-default']");
    ...
    public void navigatingToArchive() throws InterruptedException {
        ...
        driver.findElement(SinceCalender).click();
    }
