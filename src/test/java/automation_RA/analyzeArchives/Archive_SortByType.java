...
public class Archive_SortByType {
    ...
    private final By SortTypeVeri = By.xpath("//*[@id=\"archives\"]/div[2]/table[2]/tbody/tr[2]/td[text()='Application']");
    ...
    public void navigatingToArchive() throws InterruptedException {
        ...
        boolean SortingByType = driver.findElement(SortTypeVeri).isDisplayed();
        System.out.println("Sorted by Type Ascending :" +SortingByType);
