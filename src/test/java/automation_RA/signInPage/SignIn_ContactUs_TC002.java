...
public class SignIn_ContactUs_TC002 {
    ...
    public void validateContactUsPage() throws InterruptedException {
        ...
        boolean AdvisoryMessage = driver.findElement(FirstNameError).isDisplayed();
        System.out.println("Please Enter First Name Message Shows :" +AdvisoryMessage);

        boolean AdvisoryMessage2 = driver.findElement(LastNameError).isDisplayed();
        System.out.println("Please Enter Last Name Message Shows :" +AdvisoryMessage2);
