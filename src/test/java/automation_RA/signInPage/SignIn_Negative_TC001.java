...
public class SignIn_Negative_TC001 {
    ...
    @Test
    public void signWithInvalidEmailValidPassword() throws InterruptedException {

        //Verify Sign in page Landing
        boolean verifyThatUserIsInSignPage = driver.findElement(ForgetPass).isDisplayed();
        System.out.println("User Unable to Login :" + verifyThatUserIsInSignPage);

        //Enter InvalidEmail ID
        driver.findElement(Email).clear();
        driver.findElement(Email).sendKeys("Safaet@Idelji.com");
        ...
        System.out.println("User is in the HomePage :" + verifyErrorMSG);
