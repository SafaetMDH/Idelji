...
public class SignIn_PrivacyPolicy {
    ...
    private final By PrivacyPolicy = By.xpath("//*[@id='polina']/form//div/p/a[text()='Privacy Policy']");
    private final By PrivacyPolicyPage = By.name("Intro");
    ...
    @Test
    public void privacyPolicyValidation() throws InterruptedException {
        ...
        driver.findElement(Password).sendKeys("Goneb4uc!");
        ...
        Thread.sleep(5000);
        boolean LandPage = driver.findElement(PrivacyPolicyPage).isDisplayed();
        System.out.println("User is on the Privacy Policy Page :" +LandPage);
